  ...
  return (
    <div className="space-y-6">
      ...
      <section aria-labelledby="stats-heading">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-lg border bg-white p-5 shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <p className="text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Questions Answered</p>
            <p className="mt-2 text-3xl font-bold text-green-600 dark:text-green-400">{data.totalQuestionsCompleted}</p>
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Across all completed sets</p>
          </div>
          <div className="rounded-lg border bg-white p-5 shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <p className="text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Completed Sets</p>
            <p className="mt-2 text-3xl font-bold text-green-600 dark:text-green-400">{data.totalCompletedSets}</p>
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {data.totalCompletedSets === 1 ? 'set completed' : 'sets completed'}
            </p>
          </div>
          <div className="rounded-lg border bg-white p-5 shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <p className="text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Average Score</p>
            <p className="mt-2 text-3xl font-bold text-green-600 dark:text-green-400">{data.averageScore}</p>
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">per set</p>
          </div>
          <div className="rounded-lg border bg-white p-5 shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <p className="text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Overall Accuracy</p>
            <p className="mt-2 text-3xl font-bold text-blue-600 dark:text-blue-400">{data.averagePercentage}%</p>
      ...
      <section aria-labelledby="nav-heading">
        <h2 id="nav-heading" className="sr-only">Quick Navigation</h2>
        <div className="grid gap-4 sm:grid-cols-2">
          <Link
            href="/student/topics"
            className="group rounded-lg border bg-white p-6 shadow-sm transition-all hover:shadow-md hover:border-green-300 dark:bg-gray-800 dark:border-gray-700 dark:hover:border-green-600"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900 group-hover:text-green-700 transition-colors dark:text-gray-100 dark:group-hover:text-green-400">My Topics</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400">Browse released topics and study lesson content</p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900 group-hover:text-green-700 transition-colors dark:text-gray-100 dark:group-hover:text-green-400">Practice Questions</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400">Complete question sets and get AI-marked feedback</p>
              </div>
            </div>
          </Link>
        </div>
      ...
      <section aria-labelledby="grade-history-heading">
        <div className="rounded-lg border bg-white shadow-sm dark:bg-gray-800 dark:border-gray-700">
          <div className="border-b bg-gray-50 px-6 py-4 dark:bg-gray-800 dark:border-gray-700">
            <h2 id="grade-history-heading" className="text-lg font-semibold text-gray-900 dark:text-gray-100">Grade History</h2>
          ...
          {data.completedSets.length > 0 ? (
              ...
              {data.completedSets.map((set) => {
                ...
                return (
                  <Link
                    ...
                    className="group flex items-center justify-between gap-4 px-6 py-4 transition-colors hover:bg-green-50/50 dark:hover:bg-green-950/30"
                  >
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-semibold text-gray-900 group-hover:text-green-700 transition-colors truncate dark:text-gray-100 dark:group-hover:text-green-400">
                        {set.subtopic_title}
                      </p>
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        {set.topic_title} &middot; {formatDate(set.answer!.submitted_at, { day: 'numeric', month: 'short', year: 'numeric' })}
                      </p>
                    </div>
                    <div className="flex items-center gap-3 flex-shrink-0">
                      ...
                      <svg className="h-4 w-4 text-gray-400 group-hover:text-green-600 transition-colors dark:text-gray-500 dark:group-hover:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="px-6 py-12 text-center">
              ...
              <h3 className="mt-4 text-lg font-semibold text-gray-700 dark:text-gray-300">No completed sets yet</h3>
